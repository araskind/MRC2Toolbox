 ...
 *
 * This code is from 
 * https://stackoverflow.com/questions/11187461/redirect-system-out-and-system-err-to-slf4j
 *
 ******************************************************************************/
...
//private static Logger sysOutLogger = LogManager.getLogger("SYSOUT");
//private static Logger sysErrLogger = LogManager.getLogger("SYSERR");
...
public static void bindOutputStream() {
    System.setOut(new PrintStream(new LoggingOutputStream(sysOutLogger, false), true));
} 
