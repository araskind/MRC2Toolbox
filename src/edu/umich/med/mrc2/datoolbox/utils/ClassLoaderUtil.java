...
/**
 * ClassLoader util for loading classes and finding resources. No checked
 * exceptions.
 *
 * @author David Yu
 * @created Jan 20, 2009
...
public final class ClassLoaderUtil {
	...
	/**
	 * Loads a class from the classloader; If not found, the classloader of the
	 * {@code context} class specified will be used.
	 */
	...
	/**
	 * Loads a class from the classloader; If not found, the classloader of the
	 * {@code context} class specified will be used. If the flag {@code checkParent}
	...
	/**
	 * Instantiates an object using its default constructor if the {@code className}
	 * is found in the classpath and loaded.
	 */
	...
	/**
	 * Loads a {@link URL} resource from the classloader; If not found, the
	 * classloader of the {@code context} class specified will be used.
	 */
	...
	/**
	 * Loads a {@link URL} resource from the classloader; If not found, the
	 * classloader of the {@code context} class specified will be used. If the flag
	 * {@code checkParent} is true, the classloader's parent is included in the
	 * lookup.
	 */
