package edu.umich.med.mrc2.datoolbox.met.example;
...
//        IteratingSDFReader reader = new IteratingSDFReader(new FileInputStream(args[0]), DefaultChemObjectBuilder.getInstance());
        IteratingSDFReader reader = 
        		new IteratingSDFReader(new FileInputStream("E:\\Development\\Java\\JavaLibs\\CDK\\Molecule Equivalence Tester (MET)\\MET-master\\data\\example.sdf"), 
        ...
        MoleculeEquivalence eq = new MoleculeEquivalence(mol1, mol2);
