...
public class DrugBankParserJdom2 {
	...
	//DRUGBANK_CATEGORIES
	//DRUGBANK_CATEGORY_MAP
	//DRUGBANK_COMPOUND_DATA
	//DRUGBANK_COMPOUND_PROPERTY_MAP
	//DRUGBANK_PATHWAY
	//DRUGBANK_PATHWAY_DRUG_MAP
	//DRUGBANK_PATHWAY_ENZYME_MAP
	//DRUGBANK_PATHWAY_MAP
	//DRUGBANK_TARGETS
//DRUGBANK_TARGET_ACTIONS
//DRUGBANK_TARGET_REFERENCES
	//DRUGBANK_CROSSREF
	//DRUGBANK_SYNONYMS
