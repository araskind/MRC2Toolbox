...
public class T3DBIntegration {

	public static void addCrossrefForT3DBBasedOnInchiKeys() throws Exception{
		
		Connection conn = ConnectionManager.getConnection();
		String query = 
				"SELECT DISTINCT D.ACCESSION, L.ACCESSION AS T3DB_ACCESSION " +
				"FROM COMPOUNDDB.T3DB_COMPOUND_DATA L, " +
				"COMPOUNDDB.COMPOUND_DATA D " +
				"WHERE L.ACCESSION NOT IN ( " +
				"SELECT SOURCE_DB_ID FROM COMPOUNDDB.COMPOUND_CROSSREF  " +
				"WHERE SOURCE_DB = 'T3DB')  " +
				"AND L.INCHIKEY = D.INCHI_KEY  ";
	...
	public static void addCrossrefForT3DBBasedOnMsReadyInchiKeys() throws Exception{
	...
	public static void addCrossrefForT3DBBasedOnSupplied() throws Exception{
		
		Connection conn = ConnectionManager.getConnection();
		String query = 
				"SELECT DISTINCT C.ACCESSION, L.ACCESSION  AS T3DB_ACCESSION  " +
				"FROM COMPOUNDDB.T3DB_CROSSREF L,  " +
	...
	public static void addCrossrefForT3DBBasedOnTautomerInchiKeys() throws Exception{
	...
	public static void copyT3DBData2compounds() throws Exception{
		...
		String compoundCopyQuery = 
				...
				"(SELECT ACCESSION, 'T3DB', COMMON_NAME,  " +
				...
				"MS_READY_INCHI_KEY2D, MS_READY_CHARGE  " +
				"FROM COMPOUNDDB.T3DB_COMPOUND_DATA WHERE ACCESSION = ?) ";
	...
	private static Set<String>getNonReferencedAccessionList(Connection conn) throws SQLException{
		...
		String query = 
				"SELECT ACCESSION FROM COMPOUNDDB.T3DB_COMPOUND_DATA "
