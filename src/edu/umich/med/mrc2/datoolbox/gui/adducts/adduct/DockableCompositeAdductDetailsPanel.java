...
public class DockableCompositeAdductDetailsPanel extends DefaultSingleCDockable {
	...
	public DockableCompositeAdductDetailsPanel() {
		
		super("DockableCompositeAdductDetailsPanel", componentIcon, "Composite adduct details", null, Permissions.MIN_MAX_STACK);
		
		setCloseable(false);	
		setLayout(new BorderLayout(0, 0));
		
		compositAdductComponentsTable = new CompositeAdductComponentsTable();
		add(new JScrollPane(compositAdductComponentsTable), BorderLayout.CENTER);
	}
	
	public void showCompositeAdductComponennts(CompositeAdduct composite) {
