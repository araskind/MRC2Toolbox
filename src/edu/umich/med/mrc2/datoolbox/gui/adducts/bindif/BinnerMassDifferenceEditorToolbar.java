...
public class BinnerMassDifferenceEditorToolbar extends CommonToolbar {
	...
	public BinnerMassDifferenceEditorToolbar(ActionListener listener) {

		super(listener);

		newModificationButton = GuiUtils.addButton(this, null, addModificationIcon, commandListener,
				MainActionCommands.NEW_BINNER_MASS_DIFFERENCE_COMMAND.getName(),
				MainActionCommands.NEW_BINNER_MASS_DIFFERENCE_COMMAND.getName(),
				buttonDimension);
		
		editModificationButton = GuiUtils.addButton(this, null, editModificationIcon, commandListener,
				MainActionCommands.EDIT_BINNER_MASS_DIFFERENCE_COMMAND.getName(),
				MainActionCommands.EDIT_BINNER_MASS_DIFFERENCE_COMMAND.getName(),
				buttonDimension);

		deleteModificationButton = GuiUtils.addButton(this, null, deleteModificationIcon, commandListener,
				MainActionCommands.DELETE_BINNER_MASS_DIFFERENCE_COMMAND.getName(),
				MainActionCommands.DELETE_BINNER_MASS_DIFFERENCE_COMMAND.getName(),
				buttonDimension);
		...
		newCompositeModificationButton = GuiUtils.addButton(this, null, newCompositeModificationIcon, listener,
				MainActionCommands.NEW_COMPOSITE_MODIFICATION_FROM_MASS_DIFF_COMMAND.getName(),
				MainActionCommands.NEW_COMPOSITE_MODIFICATION_FROM_MASS_DIFF_COMMAND.getName(),
				buttonDimension);
	}
