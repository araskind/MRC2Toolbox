...
public class ColorPickerDialog extends JDialog implements ChangeListener {
	...
	public ColorPickerDialog(ActionListener listener) {
		...
		selectColorButton = new JButton(MainActionCommands.SELECT_COLOR_COMMAND.getName());		
		selectColorButton.setActionCommand(MainActionCommands.SELECT_COLOR_COMMAND.getName());
	...
	public String getNewColorCode() {
		return ColorUtils.rgb2hex(newColor);
	}
	
	public void setSelectedColor(Color selected) {
		tcc.setColor(selected);
	}
}
