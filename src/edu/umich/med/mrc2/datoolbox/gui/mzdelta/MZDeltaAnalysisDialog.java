...
public class MZDeltaAnalysisDialog extends JDialog implements ActionListener, BackedByPreferences{
	...
	private MassDifferenceTable coeluteMzList;
	private MassDifferenceTable rtSeriesMzList;
	private JFormattedTextField coeluteMassErrorTextField;
	private JComboBox<MassErrorType> coeluteMassErrorTypeComboBox;
	private JFormattedTextField coeluteRtErrorTextField;
	...
	private static final String ADD_COELUTING_MASS = "ADD_COELUTING_MASS";
	...
	public MZDeltaAnalysisDialog(ActionListener actionListener) {
		...
		coelutePanel.setBorder(new CompoundBorder(
				new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), 
						new Color(160, 160, 160)), "Co-eluting mass differences", 
		...
		coeluteMzList = new MassDifferenceTable();
		...
		coelutePanel.add(new JScrollPane(coeluteMzList), gbc_scrollPane);
		
		JButton addCoElutingMassButton = new JButton("Add value");
		addCoElutingMassButton.setActionCommand(ADD_COELUTING_MASS);
		addCoElutingMassButton.addActionListener(this);
		...
		coelutePanel.add(addCoElutingMassButton, gbc_addCoElutingMassButton);
		...
		coeluteMassErrorTextField = 
				new JFormattedTextField(MRC2ToolBoxConfiguration.getPpmFormat());
		coeluteMassErrorTextField.setMinimumSize(new Dimension(60, 20));
		coeluteMassErrorTextField.setPreferredSize(new Dimension(80, 20));
		...
		coelutePanel.add(coeluteMassErrorTextField, gbc_coeluteMassErrorTextField);
		
		coeluteMassErrorTypeComboBox = 
		...
		coelutePanel.add(coeluteMassErrorTypeComboBox, gbc_coeluteMassErrorTypeComboBox);
		...
		coeluteRtErrorTextField = 
				new JFormattedTextField(MRC2ToolBoxConfiguration.getRtFormat());
		coeluteRtErrorTextField.setPreferredSize(new Dimension(80, 20));
		...
		coelutePanel.add(coeluteRtErrorTextField, gbc_coeluteRtErrorTextField);
		...
		rtSeriesMzList = new MassDifferenceTable();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(command.equals(ADD_COELUTING_MASS)) {
			coeluteMzList.addRowAndStartEditing();
		}
