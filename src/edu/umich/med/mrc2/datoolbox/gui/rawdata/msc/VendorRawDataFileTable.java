...
public class VendorRawDataFileTable extends BasicTable {
...
//		setDefaultRenderer(File.class, new FileBaseNameRenderer());
		
		columnModel.getColumnById(VendorRawDataFileTableModel.DATA_FILE_COLUMN)
	...
	public Collection<File>getSelectedFiles(){
		...
		int fileColumn = model.getColumnIndex(VendorRawDataFileTableModel.DATA_FILE_COLUMN);
