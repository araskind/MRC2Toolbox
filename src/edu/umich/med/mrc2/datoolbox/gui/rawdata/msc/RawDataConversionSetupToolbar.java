...
public class RawDataConversionSetupToolbar extends CommonToolbar {
	...
	private static final Icon selectOutputFolderIcon = GuiUtils.getIcon("openDataFile", 32);
	...
	public RawDataConversionSetupToolbar(ActionListener commandListener) {
