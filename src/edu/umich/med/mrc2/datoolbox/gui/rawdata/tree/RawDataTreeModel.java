...
public class RawDataTreeModel extends DefaultTreeModel {
	...
	private static final MsFeatureInfoBundleComparator rtSorter = 
			new MsFeatureInfoBundleComparator(SortProperty.RT);
		...
		if(treeGrouping.equals(TreeGrouping.BY_DATA_FILE)) {
			...
			if(MRC2ToolBoxCore.getActiveOfflineRawDataAnalysisExperiment() != null) {
				...
				Collection<MSFeatureInfoBundle> msmsFeatures = 
						MRC2ToolBoxCore.getActiveOfflineRawDataAnalysisExperiment().getMsFeaturesForDataFile(dataFile);
