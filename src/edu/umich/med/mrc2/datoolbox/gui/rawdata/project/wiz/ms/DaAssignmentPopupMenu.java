...
public class DaAssignmentPopupMenu extends JPopupMenu {
	...
	public DaAssignmentPopupMenu(ActionListener listener) {

		super();

		assignLevelsMenuItem = GuiUtils.addMenuItem(this,
				MainActionCommands.ASSIGN_DA_METHOD_TO_DATA_FILES_DIALOG_COMMAND.getName(), listener,
				MainActionCommands.ASSIGN_DA_METHOD_TO_DATA_FILES_DIALOG_COMMAND.getName());
