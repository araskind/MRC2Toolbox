...
import edu.umich.med.mrc2.datoolbox.gui.idtlims.dataimport.DAMethodAssignmentDialog;
import edu.umich.med.mrc2.datoolbox.gui.idtlims.dataimport.IDtrackerDataFileSampleMatchTable;
	...
	public void statusChanged(TaskEvent e) {
		...
		if (e.getStatus() == TaskStatus.FINISHED) {
			...
			if (e.getSource().getClass().equals(MSMSSearchResultsBatchPrescanTask.class))				
				finalizeMSMSSearchResultsBatchPrescanTask((MSMSSearchResultsBatchPrescanTask)e.getSource());
		}
