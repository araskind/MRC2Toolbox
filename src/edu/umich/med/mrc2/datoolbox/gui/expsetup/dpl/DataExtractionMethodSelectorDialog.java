...
public class DataExtractionMethodSelectorDialog extends JDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6343877672595301492L;
	private static final Icon dataAnalysisMethodIcon = GuiUtils.getIcon("dataAnalysisMethodIcon", 32);
	private JButton btnSave;
	private DataExtractionMethodTable dataExtractionMethodTable;
	
	public DataExtractionMethodSelectorDialog(ActionListener listener) {
		super();
		setTitle("Select data analysis method");
		setIconImage(((ImageIcon) dataAnalysisMethodIcon).getImage());
		...
		JScrollPane scrollPane = new JScrollPane(dataExtractionMethodTable);
		...
		btnSave = new JButton(
				MainActionCommands.SELECT_DATA_EXTRACTION_METHOD_COMMAND.getName());
	...
	public DataExtractionMethod getSelectedMethod() {
		return dataExtractionMethodTable.getSelectedMethod();
	}
}
