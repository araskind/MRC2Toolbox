...
public class DockableCompoundDatabaseSearchPanel extends DefaultSingleCDockable implements ActionListener, BackedByPreferences{

	/**
	 *
	 */
	private static final long serialVersionUID = 1819435055078559383L;
	private static final Icon componentIcon = GuiUtils.getIcon("dbLookup", 16);
	
	private Preferences preferences;
	public static final String PREFS_NODE = DockableCompoundDatabaseSearchPanel.class.getName();
	...
	public DockableCompoundDatabaseSearchPanel(ActionListener listener) {

		super("DockableCompoundDatabaseSearchPanel", componentIcon, "Search compound database", null, Permissions.MIN_MAX_STACK);
		setCloseable(false);
