...
public class AddCustomCompoundTestFrame extends JFrame implements ActionListener, ItemListener, WindowListener {
	...
	public static void main(String[] args) {
		...
		AddCustomCompoundTestFrame frame = new AddCustomCompoundTestFrame(null);	
		frame.setLocationRelativeTo(null);
		frame.setVisible(true);
	}

	public AddCustomCompoundTestFrame(ActionListener actionListener) {
		super();
