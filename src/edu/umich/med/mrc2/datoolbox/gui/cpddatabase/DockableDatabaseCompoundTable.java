...
public class DockableDatabaseCompoundTable extends DefaultSingleCDockable{

	private static final Icon componentIcon = GuiUtils.getIcon("table", 16);
	private DatabaseCompoundTable databaseCompoundTable;

	public DockableDatabaseCompoundTable() {

		super("DockableDatabaseCompoundTable", componentIcon, "Database search results", null, Permissions.MIN_MAX_STACK);
		setCloseable(false);
		setLayout(new BorderLayout(0,0));

		databaseCompoundTable = new DatabaseCompoundTable();
	...
	public void updateCidData(MsFeatureIdentity id) {
		databaseCompoundTable.updateCidData(id);
	}
