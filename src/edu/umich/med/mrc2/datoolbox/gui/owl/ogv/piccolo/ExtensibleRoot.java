...
public class ExtensibleRoot extends PRoot {
	...
	private PActivitySchedulerMod activityScheduler;
	...
	protected PActivitySchedulerMod createActivityScheduler() {
		return new PActivitySchedulerMod(this);
	}

	public void setActivityScheduler(PActivitySchedulerMod scheduler) {
	 ...
	 */
	@Override
	public PActivitySchedulerMod getActivityScheduler() {
