...
public class ClusterTreeMouseHandler extends MouseAdapter {
	 ...
	 * Constructor
	 */
	public ClusterTreeMouseHandler(ClusterTree clusterTree, ActionListener featurePopupListener) {
	...
	private void handlePopupTriggerEvent(MouseEvent e) {
		...
		if (clickedObject instanceof MsFeature && featurePopupMenu != null)
