...
//		copyCompleteMassListMenuItem;
	...
	public MsMsTablePopupMenu(ActionListener listener) {
		...
		copySpectrumAsTsvMenuItem = GuiUtils.addMenuItem(this,
				MainActionCommands.COPY_SPECTRUM_AS_TSV_COMMAND.getName(), listener,
				MainActionCommands.COPY_SPECTRUM_AS_TSV_COMMAND.getName());
		copySpectrumAsTsvMenuItem.setIcon(copyAsTSVIcon);
		
		copyNormalizedSpectrumAsTsvMenuItem = GuiUtils.addMenuItem(this,
		...
		copyFeatureWithMetadataMenuItem = GuiUtils.addMenuItem(this,
				MainActionCommands.COPY_FEATURE_WITH_METADATA_COMMAND.getName(), listener,
				MainActionCommands.COPY_FEATURE_WITH_METADATA_COMMAND.getName());
		copyFeatureWithMetadataMenuItem.setIcon(copyFeatureIcon);
		
		copyScanWithMetadataMenuItem = GuiUtils.addMenuItem(this,
				MainActionCommands.COPY_SCAN_WITH_METADATA_COMMAND.getName(), listener,
