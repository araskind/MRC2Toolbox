...
public class ReferenceMsMsLibraryRenderer extends DefaultTableCellRenderer {
	...
	public ReferenceMsMsLibraryRenderer(SortProperty field) {
		super();
		this.field = field;
	}
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
		...
		if (value instanceof ReferenceMsMsLibrary) {

			if(field.equals(SortProperty.ID))
				setText(((ReferenceMsMsLibrary) value).getSearchOutputCode());

			if(field.equals(SortProperty.Name))
				setText(((ReferenceMsMsLibrary) value).getName());
		}
		return this;
	}
}
