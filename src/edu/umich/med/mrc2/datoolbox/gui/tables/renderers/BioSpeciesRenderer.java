...
public class BioSpeciesRenderer extends DefaultTableCellRenderer {
	...
	public BioSpeciesRenderer(SortProperty field) {
		super();
		this.field = field;
	}
	...
	public Component getTableCellRendererComponent(
		...
		if (value instanceof LIMSBioSpecies) {

			LIMSBioSpecies species = (LIMSBioSpecies) value;
			if(field.equals(SortProperty.Name))
				setText(species.getSpeciesPrimaryName());
			else if(field.equals(SortProperty.ID))
				setText(Integer.toString(species.getTaxonomyId()));
			else
				setText("");
		}
		return this;
