...
public class SampleTypeRenderer extends DefaultTableCellRenderer {
	...
	public SampleTypeRenderer(SortProperty field) {
		super();
		this.field = field;
	}
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
		...
		if (value instanceof LIMSSampleType) {

			LIMSSampleType sampleType = (LIMSSampleType) value;
			if(field.equals(SortProperty.Name))
				setText(sampleType.getName());
			else if(field.equals(SortProperty.ID))
				setText(sampleType.getId());
			else
				setText("");
		}
		return this;
