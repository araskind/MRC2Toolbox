...
public class BinnerAnnotationListRenderer extends DefaultTableCellRenderer {

	private SortProperty field;

	public BinnerAnnotationListRenderer(SortProperty field) {
		super();
		this.field = field;
	}
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
		...
		if (value instanceof BinnerAdductList) {
			
			BinnerAdductList adductList = (BinnerAdductList)value;

			if(field.equals(SortProperty.ID))
				setText(adductList.getId());

			if(field.equals(SortProperty.Name))
				setText(adductList.getName());
			
			if(field.equals(SortProperty.Description))
				setText(adductList.getDescription());			
		}
		return this;
	}
}
