...
public class AverageMassSpectrumRenderer extends WordWrapCellRenderer {
	...
	public AverageMassSpectrumRenderer() {
		super();
		property = SortProperty.dataFile;
	}
	
	public AverageMassSpectrumRenderer(SortProperty property) {
		super();
    ...
    public Component getTableCellRendererComponent(
		...
		if (AverageMassSpectrum.class.isAssignableFrom(value.getClass())) {
			
			if(property.equals(SortProperty.dataFile))
				setText(((AverageMassSpectrum) value).getDataFile().getName());
			
			if(property.equals(SortProperty.Name))
				setText(((AverageMassSpectrum) value).toString());
