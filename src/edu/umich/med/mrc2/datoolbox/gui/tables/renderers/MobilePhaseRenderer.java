...
public class MobilePhaseRenderer extends DefaultTableCellRenderer {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 2404383437376329072L;
	private SortProperty property;

	public MobilePhaseRenderer() {
		super();
		property = SortProperty.Name;
	}
	
	public MobilePhaseRenderer(SortProperty property) {
		super();
    ...
    public Component getTableCellRendererComponent(
		...
		if (value instanceof MobilePhase) {
			
			if(property.equals(SortProperty.Name))
				setText(((MobilePhase) value).getName());
			
			if(property.equals(SortProperty.ID))
				setText(((MobilePhase) value).getId());
		}
        return this;
    }
}
