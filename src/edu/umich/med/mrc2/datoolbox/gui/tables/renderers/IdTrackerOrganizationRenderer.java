...
public class IdTrackerOrganizationRenderer extends WordWrapCellRenderer {
	...
	public IdTrackerOrganizationRenderer(SortProperty property) {
		super();
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
		...
		if (value instanceof IdTrackerOrganization) {
			...
			if(property.equals(SortProperty.Name))
				setText(((IdTrackerOrganization) value).getName());
			
			if(property.equals(SortProperty.ID))
				setText(((IdTrackerOrganization) value).getId());
		}
