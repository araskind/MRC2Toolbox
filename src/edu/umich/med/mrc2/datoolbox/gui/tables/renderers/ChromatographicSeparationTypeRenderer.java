...
public class ChromatographicSeparationTypeRenderer extends DefaultTableCellRenderer {
	...
	public ChromatographicSeparationTypeRenderer(SortProperty field) {
		super();
		this.field = field;
	}
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
		...
		if (value instanceof ChromatographicSeparationType) {

			ChromatographicSeparationType selectedType = (ChromatographicSeparationType) value;
			if(field.equals(SortProperty.Description))
				setText(selectedType.getDescription());
			else if(field.equals(SortProperty.ID))
				setText(selectedType.getId());
			else
				setText("");
		}
		return this;
