...
public class ExperimentalSampleRenderer extends DefaultTableCellRenderer {
	...
	public ExperimentalSampleRenderer(SortProperty field) {
		super();
		this.field = field;
	}
