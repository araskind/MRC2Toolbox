...
import edu.umich.med.mrc2.datoolbox.gui.utils.TCheckBox;

public class TristateCheckboxRenderer implements TableCellRenderer {

	public TCheckBox btn = new TCheckBox();
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
    	...
    	if (value instanceof Integer) {
    		btn.setSelectionState((Integer)value);
    	} 
