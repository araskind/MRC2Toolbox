...
public abstract class DockableParametersPanel extends DefaultSingleCDockable 
	...
	public DockableParametersPanel(
			String id, 
			Icon icon, 
			String title, 
			Permissions permissions) {
		super(id, icon, title, null, permissions);	
	...
	public void fireFormChangeEvent(ParameterSetStatus newStatus) {
		...
		FormChangeEvent event = new FormChangeEvent(this.getContentPane(), newStatus);
