...
public class ExperimentDesignFactorEvent  extends EventObject {
	...
	public ExperimentDesignFactorEvent(
			ExperimentDesignFactor source,
	...
	public ExperimentDesignFactor getSource() {
		return (ExperimentDesignFactor) this.source;
	}
