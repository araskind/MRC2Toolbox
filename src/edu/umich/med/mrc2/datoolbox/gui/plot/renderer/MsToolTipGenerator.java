 ...
 */
class MsToolTipGenerator implements XYToolTipGenerator {
	...
	public String generateToolTip(XYDataset dataset, int series, int item) {
		...
		String tooltip = "<html><b>m/z:</b> " + MRC2ToolBoxConfiguration.getMzFormat().format(mzValue) + "<br><b>Intensity:</b> "
				+ MRC2ToolBoxConfiguration.getIntensityFormat().format(intValue);
