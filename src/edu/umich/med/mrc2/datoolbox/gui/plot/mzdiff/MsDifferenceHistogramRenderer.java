...
public class MsDifferenceHistogramRenderer extends XYBarRenderer {

	/**
	 *
	 */
	private static final long serialVersionUID = -5985807947818351309L;
	...
	private MsDifferenceHistogramTooltipGenerator toolTipGenerator;

	public MsDifferenceHistogramRenderer() {
		...
		toolTipGenerator = new MsDifferenceHistogramTooltipGenerator();
	...
	public MsDifferenceHistogramRenderer(Color color, boolean isTransparent) {
	...
	public MsDifferenceHistogramRenderer(Color color, float width) {
