...
public class ObjectMappedTimeSeriesWithCustomErrors extends ObjectMappedTimeSeries {

	private static final long serialVersionUID = 539235439151398775L;

	private Map<RegularTimePeriod,Number[]>errors;
	private Range fullDataRange;
	
	public ObjectMappedTimeSeriesWithCustomErrors(Comparable name) {
	...
	public void add(Date x, Number y, Number min, Number max, Object labelObject) {

		super.add(x, y, labelObject);
