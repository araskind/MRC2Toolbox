...
public class CorrelationMapDataSet extends DefaultXYZDataset {
...
//				labels[count][0] = corrMatrix.getRowLabel(i);
//				labels[count][1] = corrMatrix.getColumnLabel(j);
	...
	public String[] getColumnLabels() {
		...
		for (int i = 0; i < corrMatrix.getColumnCount(); i++)
			labels.add(corrMatrix.getColumnLabel(i));
	...
	public String[] getRowLabels() {
		...
		for (int i = 0; i < corrMatrix.getRowCount(); i++)
			labels.add(corrMatrix.getRowLabel(i));
	...
	public Range getDataRange() {
		...
		Range dataRange = new Range(corrMatrix.getMinValue(), corrMatrix.getMaxValue());
