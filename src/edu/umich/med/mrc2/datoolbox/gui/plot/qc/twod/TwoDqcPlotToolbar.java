...
public class TwoDqcPlotToolbar extends PlotToolbar implements ActionListener, ItemListener{
	...
	public TwoDqcPlotToolbar(Dockable2DQCPanel parentPlotContainerPanel) {
		...
		imageMap.put(QcPlotType.BARCHART, GuiUtils.getIcon("barChart", 24));
		imageMap.put(QcPlotType.BOXPLOT, GuiUtils.getIcon("boxplot", 24));
		imageMap.put(QcPlotType.LINES, GuiUtils.getIcon("lines", 24));
		imageMap.put(QcPlotType.SCATTER, GuiUtils.getIcon("scatter", 24));
