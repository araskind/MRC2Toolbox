...
public class DockableMoTrPACTissueCodeListingPanel extends DefaultSingleCDockable {

	private static final Icon componentIcon = GuiUtils.getIcon("tissueCode", 16);
	private TissueCodeTable tissueCodesTable;

	public DockableMoTrPACTissueCodeListingPanel() {

		super("DockableMoTrPACTissueCodeListingPanel", componentIcon, "Experiment tissues", null, Permissions.MIN_MAX_STACK);
		setCloseable(false);
	...
	public void loadTissueCodes(Collection<MoTrPACTissueCode>tissueCodes) {
		tissueCodesTable.setTableModelFromTissueCodes(tissueCodes);
	}
	...
	public TissueCodeTable getTable() {
		return tissueCodesTable;
	}
}
