...
public class FileSelectionTablePopupMenu extends JPopupMenu {
	...
	private static final Icon assignBatchIcon = GuiUtils.getIcon("batchDropdown", 24);
	...
	private JMenuItem assignBatchMenuItem;

	public FileSelectionTablePopupMenu(ActionListener listener) {
		...
		assignBatchMenuItem = GuiUtils.addMenuItem(this,
				MainActionCommands.ASSIGN_BATCH_FOR_SELECTED_DATA_FILES_COMMAND.getName(), listener,
				MainActionCommands.ASSIGN_BATCH_FOR_SELECTED_DATA_FILES_COMMAND.getName());
		assignBatchMenuItem.setIcon(assignBatchIcon);
	}
}
