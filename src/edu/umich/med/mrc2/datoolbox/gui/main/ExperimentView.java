...
public interface ExperimentView {
	...
	//	Load data for assay
	void switchDataPipeline(DataAnalysisProject project, DataPipeline pipeline);
	
	//	Adjust GUI elements based on project properties (has design, has data, has libraries, etc)
