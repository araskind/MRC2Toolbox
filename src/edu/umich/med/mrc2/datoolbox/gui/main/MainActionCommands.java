...
public enum MainActionCommands {
	...
	// Project
	NEW_METABOLOMICS_XML_EXPERIMENT_COMMAND("New metabolomics experiment"),
	CREATE_NEW_METABOLOMICS_XML_EXPERIMENT_COMMAND("Create new metabolomics experiment"),
	OPEN_METABOLOMICS_XML_EXPERIMENT_COMMAND("Open metabolomics experiment"),
	...
	LOAD_TARGETED_DATA_FROM_PLAIN_TEXT_COMMAND("Load targeted data from plain text"),
	SELECT_TARGETED_DATA_FILE_COMMAND("Select targeted data file"),
	...
	PARSE_TARGETED_DATA_COMMAND("Parse targeted data file"),
	...
	EXPORT_RESULTS_4METAB_COMBINER_COMMAND("Export results for MetabCombiner"),
	...
	SHOW_BINNER_ANNOTATED_FEATURES_COMMAND("Show Binner annotated features"),
	SHOW_PRIMARY_BINNER_ANNOTATED_FEATURES_COMMAND("Show Binner annotated features (primary only)"),
	...
	SAVE_CHANGES_TO_MS_LIBRARY_COMMAND("Save changes to library"),
	...
	SETUP_EXTERNAL_LIBRARY_COMPOUND_VALIDATION_COMMAND("Setup library compound validation"),
	VALIDATE_LIBRARY_COMPOUNDS_AGAINST_DATABASE_COMMAND("Validate library compounds for import against compound database"),
	VALIDATE_LIBRARY_COMPOUNDS_AGAINST_MASTER_LIBRARY_COMMAND("Validate library compounds for import against master library"),
	SETUP_EXTERNAL_LIBRARY_IMPORT_COMMAND("Setup library import"),
	IMPORT_EXTERNAL_LIBRARY_COMMAND("Import external library data into active library"),
	...
	SHOW_MSMS_CLUSTER_ID_SUMMARY_EXPORT_DIALOG_COMMAND("MSMS clusters identification summary data export setup"),
	EXPORT_MSMS_CLUSTER_ID_SUMMARY_COMMAND("Export MSMS clusters identification summary data"),	
