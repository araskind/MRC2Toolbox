...
public enum MainActionCommands {
	...
	PRESCAN_LIBRARY_COMPOUNDS_AGAINST_DATABASE_COMMAND("Prescan library for import against compound database"),
	PRESCAN_LIBRARY_COMPOUNDS_AGAINST_MASTER_LIBRARY_COMMAND("Prescan library for import against master library"),
	RUN_PRESCAN_AGAINST_MASTER_LIBRARY_COMMAND("Verify library against master"),
	...
	SET_UP_PCDL_DATA_IMPORT_INTO_ACTIVE_COMMAND("Set up PCDL data import into active library"),
	IMPORT_PCDL_COMPOUND_LIBRARY_INTO_ACTIVE_COMMAND("Import PCDL data into active library"),
