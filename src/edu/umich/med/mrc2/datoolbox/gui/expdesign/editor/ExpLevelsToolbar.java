...
public class ExpLevelsToolbar extends JToolBar{
	...
	public ExpLevelsToolbar(ActionListener actionListener) {
		...
		addLevelButton = GuiUtils.addButton(this, null, addLevelIcon, commandListener,
				MainActionCommands.ADD_LEVEL_COMMAND.getName(),
				MainActionCommands.ADD_LEVEL_COMMAND.getName(), buttonDimension);

		removeLevelButton = GuiUtils.addButton(this, null, deleteLevelIcon, commandListener,
				MainActionCommands.DELETE_LEVEL_COMMAND.getName(),
				MainActionCommands.DELETE_LEVEL_COMMAND.getName(), buttonDimension);
	}
}
