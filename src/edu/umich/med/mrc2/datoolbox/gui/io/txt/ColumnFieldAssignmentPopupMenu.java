...
public class ColumnFieldAssignmentPopupMenu extends JPopupMenu {
	...
	private JMenuItem deleteDataFileMenuItem;

	public ColumnFieldAssignmentPopupMenu(ActionListener listener) {
		...
		deleteDataFileMenuItem = GuiUtils.addMenuItem(this,
				MainActionCommands.REMOVE_DATA_FILES_COMMAND.getName(), listener,
				MainActionCommands.REMOVE_DATA_FILES_COMMAND.getName());
		deleteDataFileMenuItem.setIcon(removeDataFilesIcon);
	}
}
