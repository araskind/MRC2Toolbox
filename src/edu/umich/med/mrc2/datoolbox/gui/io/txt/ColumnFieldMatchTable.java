...
public class ColumnFieldMatchTable extends BasicTable {
	...
	public DataFile[] getActiveDataFiles() {
		...
		int fileColumn = model.getColumnIndex(ColumnFieldMatchTableModel.DATA_FILE_COLUMN);
		int activeColumn = model.getColumnIndex(ColumnFieldMatchTableModel.ENABLED_COLUMN);		
