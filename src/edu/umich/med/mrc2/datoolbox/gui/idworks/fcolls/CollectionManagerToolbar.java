...
public class CollectionManagerToolbar extends CommonToolbar {
	...
	public CollectionManagerToolbar(ActionListener commandListener) {

		super(commandListener);

		refreshDataButton = GuiUtils.addButton(this, null, refreshDataIcon, commandListener,
				MainActionCommands.REFRESH_FEATURE_AND_CLUSTER_COLLECTIONS_COMMAND.getName(),
				MainActionCommands.REFRESH_FEATURE_AND_CLUSTER_COLLECTIONS_COMMAND.getName(),
				buttonDimension);
	}
