...
public class BinnerAnnotationsLookupDataSetEditorDialog extends JDialog 
	...
	public static final String PREFS_NODE = 
			"edu.umich.med.mrc2.datoolbox.gui.BinnerAnnotationsLookupDataSetEditorDialog";
	...
	public BinnerAnnotationsLookupDataSetEditorDialog(
			BinnerAnnotationLookupDataSet datSet,
		...
		gbc_panel_1.gridx = 0;
		gbc_panel_1.gridy = 2;
		dataPanel.add(binnerAnnotationsImportPanel, gbc_panel_1);
	...
	private void loadDataSet() {
		...
		if(dataSet == null) {
			...
			binnerAnnotationsImportPanel.disableLoadingFeaturesFromDatabase();
		}
		else {
			setTitle("Edit information for " + dataSet.getName());
			setIconImage(((ImageIcon) editFeatureCollectionIcon).getImage());
			btnSave.setActionCommand(MainActionCommands.EDIT_BINNER_ANNOTATIONS_DATA_SET_COMMAND.getName());
