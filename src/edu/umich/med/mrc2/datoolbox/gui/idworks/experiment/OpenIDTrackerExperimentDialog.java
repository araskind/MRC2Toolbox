...
public class OpenIDTrackerExperimentDialog extends JDialog {
	...
	public OpenIDTrackerExperimentDialog(ActionListener listener) {
		...
		btnSave.setActionCommand(MainActionCommands.OPEN_IDTRACKER_EXPERIMENT_COMMAND.getName());
