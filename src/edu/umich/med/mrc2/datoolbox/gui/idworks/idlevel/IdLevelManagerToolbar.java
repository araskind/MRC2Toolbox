...
public class IdLevelManagerToolbar extends CommonToolbar {
	...
	public IdLevelManagerToolbar(ActionListener commandListener) {

		super(commandListener);

		addIdStatusButton = GuiUtils.addButton(this, null, addIdStatusIcon, commandListener,
				MainActionCommands.ADD_ID_LEVEL_DIALOG_COMMAND.getName(),
				MainActionCommands.ADD_ID_LEVEL_DIALOG_COMMAND.getName(),
				buttonDimension);
