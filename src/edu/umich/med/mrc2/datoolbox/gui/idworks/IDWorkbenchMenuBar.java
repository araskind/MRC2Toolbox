...
public class IDWorkbenchMenuBar extends CommonMenuBar {
	...
	private static final Icon exportMSMSClustersIDSummaryIcon = GuiUtils.getIcon("clustersSummary", 24);	
	...
	private static final Icon filterIDLIcon = GuiUtils.getIcon("filterIdStatus", 24);
	...
	private JMenuItem
		...
		exportMSMSClusterIDSummaryMenuItem,
	...
	public IDWorkbenchMenuBar(ActionListener listener) {
		...
		filterMSMSFeaturesByIDLMenuItem = addItem(databaseSearchMenu, 
				MainActionCommands.SHOW_FEATURE_IDL_ANNOTATION_FILTER_COMMAND, 
				filterIDLIcon);
...
//				findMSMSFeaturesIcon);
		...
		filteredDataSetSummaryMenuItem = addItem(explorationMenu, 
				MainActionCommands.SHOW_FILTERED_DATA_SUMMARY_COMMAND, 
				statsFilteredIcon);
		...
		exportMSMSClusterIDSummaryMenuItem = addItem(exportMenu, 
				MainActionCommands.SHOW_MSMS_CLUSTER_ID_SUMMARY_EXPORT_DIALOG_COMMAND, 
				exportMSMSClustersIDSummaryIcon);				
