...
public class MultipleFeaturesFollowupStepAssignmentDialog extends JDialog {


	/**
	 * 
	 */
	private static final long serialVersionUID = -722733817471428674L;
	...
	public MultipleFeaturesFollowupStepAssignmentDialog(ActionListener listener) {

		super();

		setTitle("Assign identification follow-up steps");
		...
		availableFollowupStepsList.setModel(
				new SortedListModel<MSFeatureIdentificationFollowupStep>(
		...
		JButton btnSaveChanges = new JButton(
				MainActionCommands.SAVE_ID_FOLLOWUP_STEP_ASSIGNMENT_COMMAND.getName());
	...
	public Collection<MSFeatureIdentificationFollowupStep>getSelectedFollowupSteps(){
		return availableFollowupStepsList.getSelectedValuesList();
	}
}
