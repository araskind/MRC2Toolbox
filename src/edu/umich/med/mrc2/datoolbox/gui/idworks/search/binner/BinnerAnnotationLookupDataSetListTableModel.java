...
public class BinnerAnnotationLookupDataSetListTableModel extends BasicTableModel {
	...
	public BinnerAnnotationLookupDataSetListTableModel() {

		super();
		columnArray = new ColumnContext[] {

			new ColumnContext(DATA_SET_COLUMN, DATA_SET_COLUMN, BinnerAnnotationLookupDataSet.class, false),
	...
	public void setTableModelFromBinnerAnnotationLookupDataSetList(
		...
		for (BinnerAnnotationLookupDataSet dataSet : dataSetList) {
