...
public class NewIDTrackerBasedExperimentDialog extends JDialog implements ActionListener {
	...
	public NewIDTrackerBasedExperimentDialog(ActionListener listener) {

		super();
		alistener = listener;

		setTitle("Create new IDTracker-based compound identification experiment");
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (event.getActionCommand().equals(NewIDTrackerBasedExperimentDialog.CHOOSE_PARENT_DIR_COMMAND)) {
