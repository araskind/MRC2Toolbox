...
public class DockableFeatureCollectionsTable extends DefaultSingleCDockable {
	...
	private FeatureCollectionManagerDialog parent;
	
	public DockableFeatureCollectionsTable(FeatureCollectionManagerDialog parent)  {

		super("DockableFeatureCollectionsTable", componentIcon, "Feature collections", null, Permissions.MIN_MAX_STACK);
		setCloseable(false);
		this.parent = parent;
	...
	public void setTableModelFromFeatureCollectionList(
		...
		featureCollectionsTable.getSelectionModel().removeListSelectionListener(parent);
