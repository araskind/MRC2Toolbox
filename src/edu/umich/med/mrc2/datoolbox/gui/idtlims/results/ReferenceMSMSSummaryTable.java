...
public class ReferenceMSMSSummaryTable extends BasicTable {
	...
	public ReferenceMSMSSummaryTable() {
		...
		rowSorter.setComparator(model.getColumnIndex(ReferenceMSMSSummaryTableModel.CHROMATOGRAPHIC_COLUMN),
				new ChromatographicColumnComparator(SortProperty.Name));
		rowSorter.setComparator(model.getColumnIndex(ReferenceMSMSSummaryTableModel.DA_METHOD),
				new AnalysisMethodComparator(SortProperty.Name));
		rowSorter.setComparator(model.getColumnIndex(ReferenceMSMSSummaryTableModel.SAMPLE_COLUMN),
				new ExperimentalSampleComparator(SortProperty.Name));
		rowSorter.setComparator(model.getColumnIndex(ReferenceMSMSSummaryTableModel.EXPERIMENT_COLUMN),
