...
public class WizardMethodsPanel extends IDTrackerDataLoadWizardPanel 
	...
	public WizardMethodsPanel(IDTrackerDataLoadWizard wizard) {
	...
	private void saveDataExtractionMethod() {
		...
		reloadDataAnalysisMethods();
		dataExtractionMethodEditorDialog.savePreferences();
	...
	public void statusChanged(TaskEvent e) {
		...
		if(e.getStatus().equals(TaskStatus.FINISHED)) {
			...
			if (e.getSource().getClass().equals(LIMSWorklistAcquisitiomMethodScanTask.class))
				 finalizeLIMSWorklistAcquisitiomMethodScanTask(
						 (LIMSWorklistAcquisitiomMethodScanTask)e.getSource());			
		}
	}
	
	private void finalizeLIMSWorklistAcquisitiomMethodScanTask(
			LIMSWorklistAcquisitiomMethodScanTask task) {
