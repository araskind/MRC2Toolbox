...
public class ProtocolManagerToolbar extends CommonToolbar {
	...
	private static final Icon downloadProtocolIcon = GuiUtils.getIcon("downloadSop", 32);
	...
	public ProtocolManagerToolbar(ActionListener commandListener) {
		...
		editProtocolButton = GuiUtils.addButton(this, null, editProtocolIcon, commandListener,
		...
		downloadProtocolButton = GuiUtils.addButton(this, null, downloadProtocolIcon, commandListener,
