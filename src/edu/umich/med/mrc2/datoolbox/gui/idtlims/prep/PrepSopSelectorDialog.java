...
public class PrepSopSelectorDialog extends JDialog {

	/**
	 *
	 */
	private static final long serialVersionUID = 988771277526975750L;
	private static final Icon addProtocolIcon = GuiUtils.getIcon("addSop", 32);
	private JButton btnSave;
	private ProtocolTable protocolTable;

	public PrepSopSelectorDialog(ActionListener actionListener) {
		...
		btnSave = new JButton("Add selected protocols");
	...
	public Collection<LIMSProtocol> getSelectedProtocols() {
		return protocolTable.getSelectedProtocols();
	}
}
