...
public class DockableDocumentsPanel extends DefaultSingleCDockable {
	...
	private SamplePrepDocsToolbar toolbar;
	private PrepDocumentsTable docsTable;

	public DockableDocumentsPanel(ActionListener listener) {

		super("DockableDocumentsPanel", componentIcon, "Documents", null, Permissions.MIN_MAX_STACK);
		setCloseable(false);
		setLayout(new BorderLayout(0, 0));

		toolbar = new SamplePrepDocsToolbar(listener);
