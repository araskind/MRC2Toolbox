...
public class DataExtractionMethodManagerToolbar extends CommonToolbar {
	...
	private static final Icon downloadMethodIcon = GuiUtils.getIcon("downloadDataProcessingMethod", 32);
	...
	private JButton
		...
		linkToDataAcquisitionMethodButton;

	public DataExtractionMethodManagerToolbar(ActionListener commandListener) {

		super(commandListener);

/*		linkToDataAcquisitionMethodButton = GuiUtils.addButton(this, null, linkToDataAcquisitionMethodIcon, commandListener,
				MainActionCommands.LINK_DATA_EXTRACTION_METHOD_TO_ACQUISITION_COMMAND.getName(),
				MainActionCommands.LINK_DATA_EXTRACTION_METHOD_TO_ACQUISITION_COMMAND.getName(),
				buttonDimension);
