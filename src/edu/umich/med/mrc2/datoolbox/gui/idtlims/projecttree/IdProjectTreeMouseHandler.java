...
public class IdProjectTreeMouseHandler extends MouseAdapter {
	...
	private static final Icon addDaResultsIcon = GuiUtils.getIcon("addDataProcessingMethod", 24);

	private IdProjectTree tree;
	private JPopupMenu
		projectPopupMenu,
		experimentPopupMenu,
		samplePrepPopupMenu,
	...
	public IdProjectTreeMouseHandler(IdProjectTree tree, ActionListener popupListener) {
		...
		addExperimentMenuItem = GuiUtils.addMenuItem(projectPopupMenu,
				MainActionCommands.NEW_CPD_ID_EXPERIMENT_DIALOG_COMMAND.getName(), popupListener,
...
//		
//		addDataAnalysisResultsMenuItem = GuiUtils.addMenuItem(samplePrepPopupMenu,
//				MainActionCommands.ADD_DATA_PROCESSING_RESULTS_DIALOG_COMMAND.getName(), popupListener,
//				MainActionCommands.ADD_DATA_PROCESSING_RESULTS_DIALOG_COMMAND.getName());
//		addDataAnalysisResultsMenuItem.setIcon(addDaResultsIcon);
