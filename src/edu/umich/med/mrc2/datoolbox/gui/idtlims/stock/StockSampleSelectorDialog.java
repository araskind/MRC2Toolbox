...
public class StockSampleSelectorDialog extends JDialog {
	...
	public StockSampleSelectorDialog(ActionListener actionListener) {
		super();
		setTitle("Select stock sample");
		...
		JScrollPane scrollPane = new JScrollPane(stockSampleTable);
		...
		btnSave.setActionCommand(MainActionCommands.SELECT_STOCK_SAMPLE_COMMAND.getName());
	...
	public StockSample getSelectedSample(){
		return stockSampleTable.getSelectedSample();
	}
}
