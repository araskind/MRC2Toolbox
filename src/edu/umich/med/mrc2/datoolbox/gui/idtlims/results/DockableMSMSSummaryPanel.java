...
public class DockableMSMSSummaryPanel extends DefaultSingleCDockable{
	...
	private ReferenceMSMSSummaryTable summaryTable;

	public DockableMSMSSummaryPanel() {

		super("DockableMSMSSummaryPanel", componentIcon, "MS/MS summary data", null, Permissions.MIN_MAX_STACK);
		setCloseable(false);
