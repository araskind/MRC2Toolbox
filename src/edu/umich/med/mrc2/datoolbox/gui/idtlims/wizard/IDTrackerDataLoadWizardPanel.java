...
public class IDTrackerDataLoadWizardPanel extends JPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6942217820551753695L;
	protected IDTrackerDataUploadStage stage;
	protected IDTrackerDataLoadWizard wizard;
	protected JButton completeStageButton;
	protected GridBagConstraints gbc_panel;

	public IDTrackerDataLoadWizardPanel(IDTrackerDataLoadWizard wizard) {
	...
	public void setStage(IDTrackerDataUploadStage stage) {
		this.stage = stage;
	}

	public IDTrackerDataUploadStage getStage() {
		return stage;
	}
}
