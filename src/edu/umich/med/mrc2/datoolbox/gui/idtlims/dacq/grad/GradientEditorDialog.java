...
public class GradientEditorDialog extends JDialog 
	...
	private static final File layoutConfigFile = new File(MRC2ToolBoxCore.configDir + "GradientEditorDialog.layout");
	
	private CControl control;
	private CGrid grid;
	private DockableGradientChartPanel gradientChartPanel;
	private DockableChromatographicGradientTable gradientTable;
	private DockableGradientStepEditorPanel gradientStepEditorPanel;
	...
	public GradientEditorDialog(
		...
		gradientStepEditorPanel = new DockableGradientStepEditorPanel(this);
		
		grid.add(0, 0, 75, 100, gradientStepEditorPanel, 
