...
public class DuplicateFeaturePopupMenu extends ClusterFeaturePopupMenu {


	/**
	 *
	 */
	private static final long serialVersionUID = 1003150891891095511L;

	public DuplicateFeaturePopupMenu(ActionListener listener) {
