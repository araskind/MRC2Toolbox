...
public class CorrelationClusterFeaturePopupMenu extends ClusterFeaturePopupMenu {


	/**
	 *
	 */
	private static final long serialVersionUID = -1103869574442882090L;

	public CorrelationClusterFeaturePopupMenu(ActionListener listener) {
	...
	protected void populateMenu() {
		...
		removeSelecteFromListMenuItem = GuiUtils.addMenuItem(this,
				MainActionCommands.REMOVE_SELECTED_FROM_CLUSTER_AND_LIST_COMMAND.getName(), listener,
				MainActionCommands.REMOVE_SELECTED_FROM_CLUSTER_AND_LIST_COMMAND.getName());
		removeSelecteFromListMenuItem.setIcon(deleteFromListIcon);

		mergeSelectedFeaturesMenuItem = GuiUtils.addMenuItem(this,
				MainActionCommands.SHOW_DUPLICATES_MERGE_DIALOG_COMMAND.getName(), listener,
