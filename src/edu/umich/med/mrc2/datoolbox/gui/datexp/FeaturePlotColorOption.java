...
public enum FeaturePlotColorOption {
	...
	FeaturePlotColorOption(String uiName) {
		this.uiName = uiName;
	}
	...
	public static FeaturePlotColorOption getFeaturePlotColorOptionByName(String oname) {
		
		for(FeaturePlotColorOption o : FeaturePlotColorOption.values()) {
