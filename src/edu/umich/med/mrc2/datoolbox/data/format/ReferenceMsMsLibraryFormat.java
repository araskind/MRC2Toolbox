...
public class ReferenceMsMsLibraryFormat extends Format {
	...
	public ReferenceMsMsLibraryFormat(SortProperty field) {
		super();
		this.field = field;
	}
	...
	public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
		...
		if(obj instanceof ReferenceMsMsLibrary) {

			library = (ReferenceMsMsLibrary)obj;
			if(field.equals(SortProperty.Name))
				return toAppendTo.append(library.getName());

			if(field.equals(SortProperty.ID))
				return toAppendTo.append(library.getUniqueId());
		}
