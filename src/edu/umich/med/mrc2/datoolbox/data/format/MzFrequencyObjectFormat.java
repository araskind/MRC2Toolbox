...
public class MzFrequencyObjectFormat extends Format {
	...
	private MzFrequencyObject mzfo;

	public MzFrequencyObjectFormat(SortProperty field) {
		this.field = field;
	}
	...
	public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
		...
		if(obj instanceof MzFrequencyObject) {

			mzfo = (MzFrequencyObject)obj;
			if(field.equals(SortProperty.rangeMidpoint))
