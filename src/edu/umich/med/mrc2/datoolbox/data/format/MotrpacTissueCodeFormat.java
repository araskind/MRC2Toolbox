...
public class MotrpacTissueCodeFormat extends Format {
	...
	private MoTrPACTissueCode code;

	public MotrpacTissueCodeFormat(SortProperty field) {
		this.field = field;
	}
	...
	public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
		...
		if(obj instanceof MoTrPACTissueCode) {

			code = (MoTrPACTissueCode)obj;
			if(field.equals(SortProperty.Name))
				return toAppendTo.append(code.getDescription());
