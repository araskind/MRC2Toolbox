...
public class SampleTypeFormat extends Format {
	...
	public SampleTypeFormat(SortProperty field) {
		this.field = field;
	}
	...
	public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
		...
		if(obj instanceof LIMSSampleType) {

			sampleType = (LIMSSampleType)obj;
			if(field.equals(SortProperty.Name))
				return toAppendTo.append(sampleType.getName());
