...
public class ChromatographicColumnFormat extends Format {
	...
	public ChromatographicColumnFormat(SortProperty field) {
		this.field = field;
	}
	...
	public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
		...
		if(obj instanceof LIMSChromatographicColumn) {

			column = (LIMSChromatographicColumn)obj;
			if(field.equals(SortProperty.Name))
				return toAppendTo.append(column.getColumnName());
