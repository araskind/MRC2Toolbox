...
public class CompoundLibraryFormat extends Format {
	...
	public CompoundLibraryFormat(SortProperty field) {
		super();
		this.field = field;
	}
	...
	public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
		...
		if(obj instanceof CompoundLibrary) {

			library = (CompoundLibrary)obj;
			if(field.equals(SortProperty.Name))
				return toAppendTo.append(library.getLibraryName());
