...
public class MoTrPACAssayFormat extends Format {
	...
	public MoTrPACAssayFormat(SortProperty field) {
		this.field = field;
	}
	...
	public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
		...
		if(obj instanceof MoTrPACAssay) {

			assay = (MoTrPACAssay)obj;
			if(field.equals(SortProperty.ID))
				return toAppendTo.append(assay.getAssayId());
			
			if(field.equals(SortProperty.Name))
				return toAppendTo.append(assay.getCode());
