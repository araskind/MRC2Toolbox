...
public class AnalysisMethodFormat extends Format {
	...
	private AnalysisMethod assay;

	public AnalysisMethodFormat(SortProperty field) {
		this.field = field;
	}
	...
	public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
		...
		if(obj instanceof AnalysisMethod) {
			...
			assay = (AnalysisMethod)obj;
			if(field.equals(SortProperty.Name))
				return toAppendTo.append(assay.getName());

			if(field.equals(SortProperty.ID))
				return toAppendTo.append(assay.getId());
		}
