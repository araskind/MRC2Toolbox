...
public class StockSampleFormat extends Format {
	...
	private StockSample sample;

	public StockSampleFormat(SortProperty field) {
		this.field = field;
	}
	...
	public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
		...
		if(obj instanceof StockSample) {

			sample = (StockSample)obj;
			if(field.equals(SortProperty.Name))
				return toAppendTo.append(sample.getSampleName());
