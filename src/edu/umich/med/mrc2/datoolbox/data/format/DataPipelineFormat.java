...
public class DataPipelineFormat extends Format {
	...
	private DataPipeline pl;

	public DataPipelineFormat(SortProperty field) {
		this.field = field;
	}
	...
	public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
		...
		if (obj instanceof DataPipeline) {
			
			pl = (DataPipeline)obj;

			if(field.equals(SortProperty.ID))
				return toAppendTo.append(pl.getCode());

			if(field.equals(SortProperty.Name))
				return toAppendTo.append(pl.getName());
