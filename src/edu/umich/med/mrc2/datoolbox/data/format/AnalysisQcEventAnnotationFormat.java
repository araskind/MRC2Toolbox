...
public class AnalysisQcEventAnnotationFormat extends Format {
	...
	private AnalysisQcEventAnnotation annotation;

	public AnalysisQcEventAnnotationFormat(SortProperty field) {
		this.field = field;
	}
	...
	public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
		...
		if(obj instanceof AnalysisQcEventAnnotation) {

			annotation = (AnalysisQcEventAnnotation)obj;
			if(field.equals(SortProperty.Quality))
				return toAppendTo.append(annotation.getQcEventType().getName());
