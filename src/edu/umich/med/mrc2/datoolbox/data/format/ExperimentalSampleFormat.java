...
public class ExperimentalSampleFormat extends Format {
	...
	public ExperimentalSampleFormat(SortProperty field) {
		this.field = field;
	}
	...
	public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
		...
		if(obj instanceof ExperimentalSample) {
			...
			if(field.equals(SortProperty.Name))
				return toAppendTo.append(sample.getName());

			if(field.equals(SortProperty.ID))
				return toAppendTo.append(sample.getId());
		}
