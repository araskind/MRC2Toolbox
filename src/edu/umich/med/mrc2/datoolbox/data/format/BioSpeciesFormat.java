...
public class BioSpeciesFormat extends Format {
	...
	public BioSpeciesFormat(SortProperty field) {
		this.field = field;
	}
	...
	public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
		...
		if(obj instanceof LIMSBioSpecies) {

			species = (LIMSBioSpecies)obj;
			if(field.equals(SortProperty.Name))
				return toAppendTo.append(species.getSpeciesPrimaryName());
