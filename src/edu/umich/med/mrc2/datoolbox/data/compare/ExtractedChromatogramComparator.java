...
public class ExtractedChromatogramComparator extends ObjectCompatrator<ExtractedChromatogram> {
	...
	public ExtractedChromatogramComparator(
			SortProperty property, SortDirection direction) {
		super(property, direction);
	}

	public ExtractedChromatogramComparator(SortProperty property) {
		super(property);
	}

	@Override
	public int compare(ExtractedChromatogram p1, ExtractedChromatogram p2) {
