...
public class CrossSectionDemo1 extends ApplicationFrame {
	...
	static class MyDemoPanel extends DemoPanel implements ChangeListener, ChartChangeListener {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -977862954741340328L;
		...
		public MyDemoPanel() {
			...
			this.subchart1 = ChartFactory.createXYLineChart("Cross-section A", "Y", "Z", dataset1,
			...
			this.subchart2 = ChartFactory.createXYLineChart("Cross-section B", "X", "Z", dataset2,
		...
		private JFreeChart createChart(XYDataset dataset) {
			...
			XYDataImageAnnotation ann = new XYDataImageAnnotation(image, -250.5, -250.5, 501.0, 501.0, true);
		...
		public void stateChanged(ChangeEvent e) {
			if (e.getSource() == this.slider1) {
				...
				XYDataset d = HeatMapUtils.extractColumnFromHeatMapDataset(this.dataset, xIndex, "Y1");
				...
				XYDataset d = HeatMapUtils.extractRowFromHeatMapDataset(this.dataset, xIndex, "Y2");
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6601695267563244311L;
	...
	private static HeatMapDataset createMapDataset() {
		DefaultHeatMapDataset d = new DefaultHeatMapDataset(501, 501, -250, 250, -250, 250);
		for (int i = 0; i < 501; i++) {
			for (int j = 0; j < 501; j++) {
