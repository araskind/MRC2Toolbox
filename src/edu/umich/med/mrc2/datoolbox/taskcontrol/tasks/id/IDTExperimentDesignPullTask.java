...
public class IDTExperimentDesignPullTask  extends AbstractTask {

	private LIMSExperiment experiment;
	private ExperimentDesign design;

	public IDTExperimentDesignPullTask(LIMSExperiment selected) {
		super();
	...
	public Task cloneTask() {
		return new IDTExperimentDesignPullTask(experiment);
	}
	...
	public void run() {
		...
		processed = 30;
		try {
			design = IDTUtils.getDesignForIDTExperiment(experiment.getId());
			if(design != null)
