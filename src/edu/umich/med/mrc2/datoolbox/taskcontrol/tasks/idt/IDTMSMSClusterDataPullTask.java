...
public class IDTMSMSClusterDataPullTask extends IDTMSMSFeatureSearchTask {
	...
	public IDTMSMSClusterDataPullTask(MSMSClusterDataSet dataSet) {
		...
		this.clusterIds = 
				MSMSClusterDataSetManager.clusterDataSetsToClusterIdsMap.get(dataSet);
	...
	protected void getMsMsFeatures() throws Exception {
		...
		//	TODO check for features in cash
