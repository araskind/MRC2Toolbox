...
public class IDTrackerProjectDataFetchTask extends AbstractTask {
	...
	public IDTrackerProjectDataFetchTask(LIMSExperiment idTrackerExperiment) {
		super();
	...
	public Task cloneTask() {
		return new IDTrackerProjectDataFetchTask(idTrackerExperiment);
	}
